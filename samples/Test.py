    ...
    def on_frame(self, controller):
        ...
        if(len(frame.hands)!=0 and len(frame.hands)!=2):
            ...
            if not frame.hands.is_empty:
                ...
                hand_properties.append(hand.direction.pitch* Leap.RAD_TO_DEG)# x rotation degrees
                hand_properties.append(hand.direction.yaw* Leap.RAD_TO_DEG)#y rotation degrees
                hand_properties.append(hand.palm_normal.roll* Leap.RAD_TO_DEG)# z rotation degrees
