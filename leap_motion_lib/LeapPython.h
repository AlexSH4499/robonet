...
public:
    ...
    virtual void onServiceChange(Leap::Controller const &arg0);
    virtual void onDeviceFailure(Leap::Controller const &arg0);
    virtual void onLogMessage(Leap::Controller const &arg0, Leap::MessageSeverity severity, int64_t timestamp, char const *msg);
